...
def genuine_imposter(test_path, assistant_path, image_size):
    ...
    for i, usr in enumerate(subject_names):
        subims = os.listdir(os.path.join(test_path, usr))
        nfeats += len(subims)
...
parser.add_argument("--out_path", type=str,
                    default="/media/zhenyuzhou/Data/Project/Finger-Knuckle-2018/Finger-Knuckle-Assistant-Recognition/checkpoint/Joint-Finger-RFNet/Joint-Left-Middle_AssistantModel-wholeimagerotationandtranslation-lr1e-05-subs8-angle0-a20-hs0_vs0_2022-11-04-22-46/output/little-protocol.npy",
                    dest="out_path")
...
gscores, iscores, _, mmat = genuine_imposter(args.test_path, args.assistant_path, args.default_size)
if args.save_mmat:
