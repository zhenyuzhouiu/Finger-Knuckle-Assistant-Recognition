...
src_npy = [
    '../../checkpoint/Joint-Finger-RFNet/Spatial-Transformer-Network/MaskLM_STNResRFNet64v3_quadruplet_ssim/output/01-protocol.npy',
    '../../checkpoint/Joint-Finger-RFNet/Spatial-Transformer-Network/MaskLM_STNResRFNet64v3_quadruplet_ssim/output/02-protocol.npy',
    '../../checkpoint/Joint-Finger-RFNet/Spatial-Transformer-Network/MaskLM_STNResRFNet64v3_quadruplet_ssim/output/04-protocol.npy',
...
color = ['#000000',
         ...
         '#ff00ff',
         '#ff0000']
dst = '../../checkpoint/Joint-Finger-RFNet/Spatial-Transformer-Network/MaskLM_STNResRFNet64v3_quadruplet_ssim/output/roc.pdf'
