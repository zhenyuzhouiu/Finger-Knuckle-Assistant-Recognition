...
src_npy = [
    '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-23-12-10-56/output/01-protocol.npy',
    '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-23-12-10-56/output/02-protocol.npy',
    '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-22-17-32-32/output/04-protocol.npy',
    ...
    '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-21-16-38-10/output/08-protocol.npy',
    '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-21-16-38-10/output/09-protocol.npy',
    '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-21-16-38-10/output/10-protocol.npy',
...
color = ['#000000',
         ...
         '#ff00ff',
         '#ff0000']
dst = '../../checkpoint/Joint-Finger-RFNet/MaskLM_FKEfficientNet_quadruplet_rsssim-r2-a0.6-2a0.3-hs2_vs2_12-23-12-10-56/output/roc.pdf'
